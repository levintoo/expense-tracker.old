...
<template>
    ...
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        ...
        <tr>
            ...
            <TableHeadLabel @click.prevent="sort('amount')" :params="params" field="amount" class="px-6 py-3">
                Amount
            </TableHeadLabel>

            <TableHeadLabel @click.prevent="sort('entry_date')" :params="params" field="entry_date" class="px-6 py-3">
                Entry Date
            </TableHeadLabel>

            <TableHeadLabel @click.prevent="sort('description')" :params="params" field="description" class="px-6 py-3">
                description
            </TableHeadLabel>

            <TableHeadLabel @click.prevent="sort('category')" :params="params" field="category" class="px-6 py-3">
                Category
            </TableHeadLabel>
        ...
        <tr v-for="datum in data.data"
            ...
            <td class="px-6 py-4">
                ...
                <PrimaryLink class="m-1" :href="route(postRoute+'.edit', datum.id)">
                    Edit({{ datum.id ?? null }})
                </PrimaryLink>

                <DangerLink as="button" method="delete" :href="route(props.postRoute+'.delete', datum.id)" class="m-1">
